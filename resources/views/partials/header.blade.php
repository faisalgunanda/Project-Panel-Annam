                ...
                <nav class="ui-app__wrapper__navbar">
                    <div class="nav-wrapper">
                        ...
                        <div class="ui-app__wrapper__navbar__leftside--icons">
                            ...
                            <a href="dashboard.html" class="brand-logo ui-app__wrapper__navbar__leftside--icon__item">Annam Store</a>
                        ...
                        <div class="ui-app__wrapper__navbar__rightside--icons right">
                            ...
                            <div id="dropdown-notifications-target" class="ui-app__wrapper__navbar__rightside--notifications__dropdown dropdown-content">
                                <ul class="collection">
                                    <li class="collection-item avatar"> <img src="{{asset('backend/assets/images/user1.jpg')}}" alt="user profile picture" class="circle"> <span class="title">Brunch this weekend?</span>
                                        <p>Ali Connors <span class="body-1">&mdash; I'll be in your neighborhood doing errands this weekend.</span></p>
                                    </li>
                                    <li class="collection-item avatar"> <img src="{{asset('backend/assets/images/user2.jpg')}}" alt="user profile picture" class="circle"> <span class="title">Oui oui</span>
                                        <p>Sandra Adams <span class="body-1">&mdash; Do you have Paris recommendations? Have you ever been?</span></p>
                                    </li>
                                    <li class="collection-item avatar"> <img src="{{asset('backend/assets/images/user3.jpg')}}" alt="user profile picture" class="circle"> <span class="title">Birthday gift</span>
                                        <p>Trevor Hansen <span class="body-1">&mdash; Have any ideas about what we should get Heidi for her birthday?</span></p>
                                    </li>
                                    <li class="collection-item avatar"> <img src="{{asset('backend/assets/images/user4.jpg')}}" alt="user profile picture" class="circle"> <span class="title">Recipe to try</span>
